...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBlack = const Color(0xFF12151C);
  late Color darkBG = const Color(0xFF5A5C60);
  late Color white = const Color(0xFFFFFFFF);
  late Color lineColor = const Color(0xFFD9D8D8);
  late Color importante1 = const Color(0xFFF8E10A);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBlack = const Color(0xFF4BF257);
  late Color darkBG = const Color(0xFF648943);
  late Color white = const Color(0xFF8F627C);
  late Color lineColor = const Color(0xFFC27444);
  late Color importante1 = const Color(0xFFF8E10A);
}
